! =====================================================================
! NAME       : gpe_solver.f90
! DESCRIPTION: Forms class for Gross-Pitaevskii solver, computing:
!
...
!$omp parallel do collapse(2) private (k)
  ...
  PURE function state_size_impl(this) result(num)
    class(GLSolver), intent(in) :: this
    integer                     :: num
    num = this%nc_               ! # Order parameter components
