...
!   CALL this%intop_%PartUpdate3D(this%px_,this%py_,this%pz_,this%nparts_)
!   CALL this%intop_%CompSpline3D(evar)
!   CALL this%intop_%DoDeposit3D(lag,nl,field)
!
...
MODULE class_GPICSplineInt
      ...
      CONTAINS
        ...
        PROCEDURE,PUBLIC :: DoInterp3D   => GPICSplineInt_Interp3D
        PROCEDURE,PUBLIC :: DoDeposit3D  => GPICSplineInt_Deposit3D
        PROCEDURE,PUBLIC :: PartUpdate3D => GPICSplineInt_PartUpdate3D
        PROCEDURE,PUBLIC :: CompSpline3D => GPICSplineInt_CompSpline3D

      END TYPE GPICSplineInt

      ! Private methods:
      PRIVATE :: GPICSplineInt_Init         , GPICSplineInt_CompSpline3D
      PRIVATE :: GPICSplineInt_PartUpdate3D , GPICSplineInt_Interp3D
...
!-----------------------------------------------------------------
  ...
  SUBROUTINE GPICSplineInt_PartUpdate3D(this,xp,yp,zp,np)
!-----------------------------------------------------------------
!-----------------------------------------------------------------
!  METHOD     : PartUpdate3D
...
!$omp parallel do
      ...
      ENDDO
    ELSE
      PRINT *, "Spline order must be 0, 1, 2 or 3."
      STOP
    ENDIF
  END SUBROUTINE GPICSplineInt_PartUpdate3D
!-----------------------------------------------------------------
!-----------------------------------------------------------------
...
!-----------------------------------------------------------------
  ...
  SUBROUTINE GPICSplineInt_CompSpline3D(this,field)
!-----------------------------------------------------------------
!-----------------------------------------------------------------
...
!-----------------------------------------------------------------
 ...
 END SUBROUTINE GPICSplineInt_CompSpline3D
!-----------------------------------------------------------------
!-----------------------------------------------------------------
