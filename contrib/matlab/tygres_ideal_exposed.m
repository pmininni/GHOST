...
sdir     = '/home/duaner/projects/incite_2011/pvec_6144_sph';
sfile    = 'spectrum.txt';
runid    = 'PVEC6144';
N        = 6144;
trange   = [0.5 2.5];
...
if ~exist('S2m','var')
  [tm S2m] = tygres_readmax(sdir, 'maximum.txt', itype, [-1 trange(2)], npl);
end

% read in time range only:
if ~exist('Grng','var')
...
%  nf = nf + 1;
  ...
  for i=1:iskip:numel(trng)
    ...
    set(gca,'YLim',[1.0e-15 10]);
    hold on;
    ic = ic + 1;
  end;
  st{numel(st)+1} = sprintf('> %s ends at t=%f',symb{j},trng(i-1));
  disp(st{numel(st)})
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
% ht = text(1,1e-20,st);
  if btitle == 1
  title([runid ': Total Energy spectra']);
  end
  xlabel('k','FontSize',szfont,'FontWeight','Bold');
  ylabel('E_V(k)+E_M(k)','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
...
%   disp(sprintf('t=%f; Em(k=1)=%f; Em(k=2)=%f; Em(k=3)=%f\n',trng(i),Srng(i,3,1),Srng(i,3,2),Srng(i,3,3)));
  ...
  xlabel('k','FontSize',szfont,'FontWeight','Bold');
  ylabel('E_M(k)/E_V(k)','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
end
...
set(h(1),'YMinorTick','on','XMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
%set(h(1),'YLim',[1e-3 7]);
if btitle == 1
title([runid ': Logarithmic decrement'],'FontWeight','Bold');
end
set(h(1),'XLim',[trange(1) trange(2)]);
xlabel('t','FontSize',szfont,'FontWeight','Bold');
ylabel('\delta(t)','FontSize',szfont,'FontWeight','Bold');
hold on;
...
xlabel('t','FontSize',szfont,'FontWeight','Bold');
ylabel('n(t)','FontSize',szfont,'FontWeight','Bold');

set(h(2),'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
...
if itype == 1
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': E_{V}(t)'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('E_V','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': <\omega^2>_{V}(t)'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('<\omega^2>','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
end
...
if itype == 2 || itype == 3 
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': E_{V}(t) and E_{M}(t)'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('E_V/E_M','FontSize',szfont,'FontWeight','Bold');
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': <\omega^2>(t), <j^2>(t)'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('<\omega^2>/<j^2>','FontSize',szfont,'FontWeight','Bold');
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': E_M / E_V'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('E_M / E_V','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
end
...
if itype == 1 
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': \Omega_{max}'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('\Omega_{max}','FontSize',szfont,'FontWeight','Bold');
  print -dpsc -append 'mystuff.ps'
  nf = nf + 1;
end 
if itype == 2 || itype == 3 
  ...
  set(gca,'XMinorTick','on','YMinorTick','on','LineWidth',lwidth, 'FontSize',szfont,'FontWeight','Bold','Box','on');
  if btitle == 1
  title([runid ': \Omega_{max}, J_{max}'],'FontSize',szfont,'FontWeight','Bold');
  end
  xlabel('t','FontSize',szfont,'FontWeight','Bold');
  ylabel('\Omega_{max}, J_{max}','FontSize',szfont,'FontWeight','Bold');
