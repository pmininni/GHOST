...
GHOST is written in Fortran 2023. To build GHOST only C and Fortran compilers are required.  More details on how to compile GHOST can be found in src/README. GHOST also includes examples of scripts in Python, Matlab, IDL, and Mathematica, to do post-analysis of the numerical simulations. It provides a library to call GHOST methods and execute GHOST from Python, allowing integration of GHOST simulations in machine learning or interactive workflows. It can also be used together with VAPOR to do still frame renderings and animations; VAPOR (the Visualization and Analysis Platform for Ocean, Atmosphere, and Solar Researchers) provides an interactive environment for 3D visualization of GHOST outputs, allowing powerful analysis of turbulent flows in systems with 3D graphics cards (https://www.vapor.ucar.edu/).
